@echo off
title Ironclaw AI - Control Center
color 0A
cls
...
echo.
echo   [LAUNCH]
echo   1. Start Ironclaw AI Server
echo   2. Start Full App (Server + UI)
echo   3. Start API Only
echo.
echo   [INSTALL]
echo   4. Install Ironclaw AI
...
echo.
echo  =====================================================
echo   Starting Ironclaw AI Server...
echo  =====================================================
echo.
cd /d "%~dp0"
...
echo.
echo  =====================================================
echo   Starting Ironclaw AI (Server + UI)...
echo  =====================================================
echo.
call start-Ironclaw.bat
pause
goto MENU
...
echo.
cd /d "%~dp0"
if exist logs\Ironclaw.log (
    type logs\Ironclaw.log
) else (
    echo   No log file found at logs\Ironclaw.log
)
echo.
pause
goto MENU
...
echo.
echo  =====================================================
echo   Thank you for using Ironclaw AI!
echo  =====================================================
echo.
